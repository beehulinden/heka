...
func TestClusterEmptyInputAddress(t *testing.T) {
	pConfig := NewPipelineConfig(nil)
	ki := new(KafkaClusterInput)
	ki.SetPipelineConfig(pConfig)
	config := ki.ConfigStruct().(*KafkaClusterInputConfig)
	err := ki.Init(config)
...
func TestClusterReceivePayloadMessage(t *testing.T) {
...
func TestClusterReceiveProtobufMessage(t *testing.T) {
